...
class Admin:
    ...
    def login(self) :
        ...
        if username == self.__username and self.__password:
            return True
    ...
    def discharge(self, patients, discharge_patients):
        ...
        if patient_index in range(len(patients)):
            patient=patients.pop(patient_index)
    ...
    def update_details(self):
        ...
        if op == 1:
            self.__username=input("Enter your updated new username?")
            ...
            self.__address=input("Enter your updated new address?")
            

        else:
            print("Your selected option is Invalid, Try again. ")
